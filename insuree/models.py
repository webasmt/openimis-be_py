...
class Family(core_models.VersionedModel, core_models.ExtendableModel):
    ...
    date_signature = core.fields.DateField(db_column='DateSignature',null=True)
...
class IdentificationType(models.Model):
    code = models.CharField(db_column='IdentificationCode', primary_key=True,
    ...
    alt_language = models.CharField(db_column='AltLanguage', max_length=50, blank=True,
